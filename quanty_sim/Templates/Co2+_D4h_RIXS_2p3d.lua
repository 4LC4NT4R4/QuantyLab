...
NPsis = 120 -- Number of states to consider in the spectra calculation.
...
-- X-axis parameters.
Emin1 = {{Parameters.Energy.Emin1}} -- Minimum value of the energy range (eV).
Emax1 = {{Parameters.Energy.Emax1}} -- Maximum value of the energy range (eV).
NPoints1 = {{Parameters.Energy.NPoints1}} -- Number of points of the spectra.
ZeroShift1 = 4.87375 -- Shift that brings the edge or line energy to approximately zero (eV).
ExperimentalShift1 = 778.1 -- Experimental edge or line energy (eV).
Gaussian1 = {{Parameters.Energy.Gaussian1}} -- 0.1 -- Gaussian FWHM (eV).
...
Emax2 = {{Parameters.Energy.Emax2}} -- Maximum value of the energy range (eV).
NPoints2 = {{Parameters.Energy.NPoints2}} -- Number of points of the spectra.
ZeroShift2 = 0.0 -- Shift that brings the edge or line energy to approximately zero (eV).
ExperimentalShift2 = 3.0 -- Experimental edge or line energy (eV).
Gaussian2 = {{Parameters.Energy.Gaussian2}} -- 0.1 -- Gaussian FWHM (eV).
...
if AtomicTerm then
    ...
    U_3d_3d_m = {{MiddleHamiltonian.U_3d_3d_m}}
    F2_3d_3d_m = {{MiddleHamiltonian.F2_3d_3d_m}} * {{ScaleFactors.Fk}}
    F4_3d_3d_m= {{MiddleHamiltonian.F4_3d_3d_m}} * {{ScaleFactors.Fk}}
    F0_3d_3d_m = U_3d_3d_m + 2 / 63 * F2_3d_3d_m + 2 / 63 * F4_3d_3d_m
    U_2p_3d_m = {{MiddleHamiltonian.U_2p_3d_m}}
    F2_2p_3d_m = {{MiddleHamiltonian.F2_2p_3d_m}} * {{ScaleFactors.Fk}}
    G1_2p_3d_m = {{MiddleHamiltonian.G1_2p_3d_m}} * {{ScaleFactors.Gk}}
    G3_2p_3d_m = {{MiddleHamiltonian.G3_2p_3d_m}} * {{ScaleFactors.Gk}}
    ...
    zeta_3d_m = {{MiddleHamiltonian.zeta_3d_m}} * {{ScaleFactors.zeta}}
    zeta_2p_m = {{MiddleHamiltonian.zeta_2p_m}} * {{ScaleFactors.zeta}}
...
if CrystalFieldTerm then
    ...
    Dq_3d_m = {{CrystalField.tenDq_3d_m}} / 10.0
    Ds_3d_m = {{CrystalField.Ds_3d_m}}
    Dt_3d_m = {{CrystalField.Dt_3d_m}}

    Dq_3d_f = {{CrystalField.tenDq_3d_f}} / 10.0
...
if LmctLigandsHybridizationTerm then
    ...
    Delta_3d_L1_m = {{LMCT.Delta_3d_L1_m}}
    ...
    Dq_L1_m = {{LMCT.Dq_L1_m}} / 10.0
    Ds_L1_m = {{LMCT.Ds_L1_m}}
    Dt_L1_m = {{LMCT.Dt_L1_m}}
    Va1g_3d_L1_m = {{LMCT.Va1g_3d_L1_m}}
    Vb1g_3d_L1_m = {{LMCT.Vb1g_3d_L1_m}}
    Vb2g_3d_L1_m = {{LMCT.Vb2g_3d_L1_m}}
    Veg_3d_L1_m = {{LMCT.Veg_3d_L1_m}}

    Dq_L1_f = {{LMCT.Dq_L1_f}} / 10.0
...
if MlctLigandsHybridizationTerm then
    ...
    Delta_3d_L2_m = {{MLCT.Delta_3d_L2_m}}
    ...
    Dq_L2_m = {{MLCT.Dq_L2_m}} / 10.0
    Ds_L2_m = {{MLCT.Ds_L2_m}}
    Dt_L2_m = {{MLCT.Dt_L2_m}}
    Va1g_3d_L2_m = {{MLCT.Va1g_3d_L2_m}}
    Vb1g_3d_L2_m = {{MLCT.Vb1g_3d_L2_m}}
    Vb2g_3d_L2_m = {{MLCT.Vb2g_3d_L2_m}}
    Veg_3d_L2_m = {{MLCT.Veg_3d_L2_m}}

    Dq_L2_f = {{MLCT.Dq_L2_f}} / 10.0
...
if MagneticFieldTerm then
    ...
    Bx_i = EnergyUnits.Tesla.value*{{Parameters.Fields.Bx_i}}
    By_i = EnergyUnits.Tesla.value*{{Parameters.Fields.By_i}}
    Bz_i = EnergyUnits.Tesla.value*{{Parameters.Fields.Bz_i}}

    Bx_m = EnergyUnits.Tesla.value*{{Parameters.Fields.Bx_m}}
    By_m = EnergyUnits.Tesla.value*{{Parameters.Fields.By_m}}
    Bz_m = EnergyUnits.Tesla.value*{{Parameters.Fields.Bz_m}}

    Bx_f = EnergyUnits.Tesla.value*{{Parameters.Fields.Bx_f}}
    By_f = EnergyUnits.Tesla.value*{{Parameters.Fields.By_f}}
    Bz_f = EnergyUnits.Tesla.value*{{Parameters.Fields.Bz_f}}
...
if ExchangeFieldTerm then
    ...
    Hx_m = {{Parameters.Fields.Hx_m}}
    Hy_m = {{Parameters.Fields.Hy_m}}
    Hz_m = {{Parameters.Fields.Hz_m}}
